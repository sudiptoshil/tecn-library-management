                    ...
                    <div class="card-block">
                        ...
                        <table class="table table-striped" >
                            <thead>
                                ...
                                <form action="{{route('display-book')}}" method="post"> 
                                @csrf
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-12">
                                            <select name="department_id" class="form-control">
                                                <option disabled selected>Select All Department</option>
                                                @foreach($department as $v_depart)

                                                    <option value="{{ $v_depart->id }}" id="department_id" name="department_id">{{ $v_depart->department_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </td>
