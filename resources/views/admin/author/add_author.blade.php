    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form class="form-horizontal" action="{{route('save-author')}}" method="POST">
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea rows="5" cols="5" class="form-control" name="address" placeholder="Author Address"></textarea>
                            </div>
                        </div>
                        <!--<div class="form-group row">-->
