            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card-box">
                        ...
                        <form action="{{route('save-book')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row col-md-12">


                                <div class="form-group row col-md-6">
                                    <label class="col-md-4 col-form-label"><span style="color: red"><i class="fas fa-star"></i></span> Book Name</label>
                                    <div class="col-md-8">
                            ...
                            <div class="row col-md-12 mt-2">
                                <div class="form-group row col-md-6">
                                    <label class="col-sm-4 col-form-label"> <span style="color: red"><i class="fas fa-star"></i></span>Author Name</label>
                            ...
                            <div class="row mt-2 col-md-12">
                                ...
                                <div class="form-group row col-md-6">
                                    <label class="col-sm-4 col-form-label">Deaprtment</label>
